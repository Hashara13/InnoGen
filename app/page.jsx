...
const HomePage = () => {
  return (
    <section className='w-full h-screen flex items-center mt-2 flex-col'>
      <h1 className='text-4xl font-bold leading-[1.15] text-black sm:text-6xl text-center'>
      Find roadmaps and keywords
        ...
        <p className='desc mt-5 text-xl text-gray-600 sm:text-xl max-w-4xl text-center'>
        Create, and share Keywords,Joggles & Roadmaps related to Software Development Technologies
        </p>
      </h1>
      <FirstScreen/>
